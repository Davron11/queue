...
<div class="profile-card">
    ...
    <div class="user-info">
        <p><strong>ПИНФЛ:</strong> <span id="pinfl">12345678901234</span></p>
        <p><strong>Телефон:</strong> <span id="phone">+998 (90) 123-45-67</span></p>
        <p><strong>Адрес:</strong> <span id="address">г. Ташкент, ул. Мирзо Улугбека, 45</span></p>
    ...
    <button class="btn" onclick="window.location.href='{{ route('dashboard') }}'">Панель</button>
